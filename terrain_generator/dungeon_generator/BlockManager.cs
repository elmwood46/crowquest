...
public partial class BlockManager : Node
{
	...
	public override void _Ready()
	{
		...
		ChunkMaterial.SetShaderParameter("_displacement", ResourceLoader.Load("res://terrain_generator/dungeon_generator/block_textures/damaged_blocks/Ground_Dirt_006_DISPa.png"));
		ChunkMaterial.SetShaderParameter("_roughness", ResourceLoader.Load("res://terrain_generator/dungeon_generator/block_textures/damaged_blocks/Ground_Dirt_006_ROUGH.jpg"));
		ChunkMaterial.SetShaderParameter("_normalmap", ResourceLoader.Load("res://terrain_generator/dungeon_generator/block_textures/damaged_blocks/Ground_Dirt_006_NORM.jpg"));
		ChunkMaterial.SetShaderParameter("_acidcurvetex", ResourceLoader.Load("res://terrain_generator/dungeon_generator/shaders/acid_damage_curve.tres"));
		ChunkMaterial.SetShaderParameter("_firecurvetex", ResourceLoader.Load("res://terrain_generator/dungeon_generator/shaders/fire_damage_curve.tres"));
		ChunkMaterial.SetShaderParameter("_damage_pulse_curvetex", ResourceLoader.Load("res://terrain_generator/dungeon_generator/shaders/pulse_damage_curve.tres"));
		ChunkMaterial.SetShaderParameter("_cracks_texture", ResourceLoader.Load("res://terrain_generator/dungeon_generator/block_textures/damaged_blocks/cracks_tex.bmp"));
		...
		//BrokenBlockShader = ResourceLoader.Load("res://terrain_generator/dungeon_generator/shaders/RIGID_BREAK_SHADER.tres") as ShaderMaterial;
		BrokenBlockShader = ResourceLoader.Load("res://terrain_generator/dungeon_generator/shaders/broken_block_shader_wholeblock.tres") as ShaderMaterial;
		BrokenBlockShader.SetShaderParameter("_albedo", TextureArray);
		BrokenBlockShader.SetShaderParameter("_displacement", ResourceLoader.Load("res://terrain_generator/dungeon_generator/block_textures/damaged_blocks/Ground_Dirt_006_DISPa.png"));
		BrokenBlockShader.SetShaderParameter("_roughness", ResourceLoader.Load("res://terrain_generator/dungeon_generator/block_textures/damaged_blocks/Ground_Dirt_006_ROUGH.jpg"));
		BrokenBlockShader.SetShaderParameter("_normalmap", ResourceLoader.Load("res://terrain_generator/dungeon_generator/block_textures/damaged_blocks/Ground_Dirt_006_NORM.jpg"));
		BrokenBlockShader.SetShaderParameter("_acidcurvetex", ResourceLoader.Load("res://terrain_generator/dungeon_generator/shaders/acid_damage_curve.tres"));
		BrokenBlockShader.SetShaderParameter("_firecurvetex", ResourceLoader.Load("res://terrain_generator/dungeon_generator/shaders/fire_damage_curve.tres"));
		BrokenBlockShader.SetShaderParameter("_cracks_texture", ResourceLoader.Load("res://terrain_generator/dungeon_generator/block_textures/damaged_blocks/cracks_tex.bmp"));
		...
		CellFractureBlockShader.SetShaderParameter("_roughness", ResourceLoader.Load("res://terrain_generator/dungeon_generator/block_textures/damaged_blocks/Ground_Dirt_006_ROUGH.jpg"));
		CellFractureBlockShader.SetShaderParameter("_normalmap", ResourceLoader.Load("res://terrain_generator/dungeon_generator/block_textures/damaged_blocks/Ground_Dirt_006_NORM.jpg"));
		CellFractureBlockShader.SetShaderParameter("_acidcurvetex", ResourceLoader.Load("res://terrain_generator/dungeon_generator/shaders/acid_damage_curve.tres"));
		CellFractureBlockShader.SetShaderParameter("_firecurvetex", ResourceLoader.Load("res://terrain_generator/dungeon_generator/shaders/fire_damage_curve.tres"));
		CellFractureBlockShader.SetShaderParameter("_cracks_texture", ResourceLoader.Load("res://terrain_generator/dungeon_generator/block_textures/damaged_blocks/cracks_tex.bmp"));
		...
		DestructibleObjectShader.SetShaderParameter("_acidcurvetex", ResourceLoader.Load("res://terrain_generator/dungeon_generator/shaders/acid_damage_curve.tres"));
		DestructibleObjectShader.SetShaderParameter("_firecurvetex", ResourceLoader.Load("res://terrain_generator/dungeon_generator/shaders/fire_damage_curve.tres"));
		DestructibleObjectShader.SetShaderParameter("_cracks_texture", ResourceLoader.Load("res://terrain_generator/dungeon_generator/block_textures/damaged_blocks/cracks_tex.bmp"));
		...
		DestructibleObjectShader.SetShaderParameter("_fuse_pulse_curve", ResourceLoader.Load("res://terrain_generator/dungeon_generator/shaders/pulse_damage_curve.tres"));
