...
public partial class Block : Resource
{
	...
	public void SetTextures()
	{
		...
		{
			Textures = [BottomTexture,TopTexture,MidTexture,MidTexture,MidTexture,MidTexture];
		}
		else if (MidTexture!= null)
		{
			Textures = [MidTexture,MidTexture,MidTexture,MidTexture,MidTexture,MidTexture];
		}
		else
		{
			Textures = [BottomTexture,TopTexture,LeftTexture,RightTexture,BackTexture,FrontTexture];
		}
	}
