...
public partial class PhysBodyTracker : Node
{
    ...
    public override void _Ready()
    {
        ...
        else if (((Node3D)ParentBody).GetParent() is Chunk3d chunk3d)
        {
            chunk3d.StartedLoading += () => UpdateTrackerInGrid(this);
            chunk3d.FinishedLoading += () => UpdateTrackerInGrid(this);
        }

        CallDeferred(MethodName.Reparent, GetTree().CurrentScene);
    }
