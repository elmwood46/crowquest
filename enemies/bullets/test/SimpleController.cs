...
public partial class SimpleController : CharacterBody3D
{
    ...
    public static SimpleController Instance { get; private set; } = null;
    private static readonly AudioStream BULLET_FIRE_SOUND = ResourceLoader.Load("res://audio/attacks/bubble-pop-283674.mp3") as AudioStream;
	float _fireTimer = 0f;
	float _fireCooldown = 0.00f; // cooldown time in seconds
	...
	public override void _PhysicsProcess(double delta)
	{
        ...
        {
            _fireTimer = 0f; // reset timer when button is released
        }
