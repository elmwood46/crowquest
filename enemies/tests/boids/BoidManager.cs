...
{
    public static readonly RDShaderFile ShaderFile = ResourceLoader.Load<RDShaderFile>("res://enemies/tests/boids/boid_simulation.glsl"); 
    ...
    private bool _has_submitted = false;
    ...
    private void SetupComputeShader()
    {
        ...
        _boid_pos_buffer = GenerateVec3FloatBuffer([.. _boid_pos]);
        var boidPosUniform = GenerateUniform(_boid_pos_buffer, RenderingDevice.UniformType.StorageBuffer, 0);

        _boid_vel_buffer = GenerateVec3FloatBuffer([.. _boid_vel]);
        ...
        _boid_data_buffer = _rd.TextureCreate(fmt, view, [_boid_data.GetData()]);
        ...
        _bindings = [boidPosUniform, boidVelUniform, _params_uniform, boidDataBufferUniform];
    ...
    {
        // if (_skipped_first_physics_step) if (RenderingServer.InstanceFlags.) _rd.Sync();
        ...
        // DEBUG move camera
		var inputDirection = Input.GetVector("MoveLeft", "MoveRight", "MoveBack", "MoveForward").Normalized();
